...
impl TerrainArtPieceKind {
    pub fn id(self) -> &'static str {
        match self {
            ...
            TerrainArtPieceKind::GrassTuftCluster => "grass_tuft_cluster",
            TerrainArtPieceKind::LooseRocks => "loose_rocks",
            TerrainArtPieceKind::DirtScrape => "dirt_scrape",
            TerrainArtPieceKind::TrenchSpoilPile => "trench_spoil_pile",
            TerrainArtPieceKind::BrokenBermEdge => "broken_berm_edge",
            TerrainArtPieceKind::FallenLog => "fallen_log",
            TerrainArtPieceKind::StakeCluster => "stake_cluster",
            TerrainArtPieceKind::SandbagShort => "sandbag_short",
            TerrainArtPieceKind::ToolMark => "tool_mark",
            TerrainArtPieceKind::CastShadowLarge => "cast_shadow_large",
            TerrainArtPieceKind::TrenchEndCapLeft => "trench_end_cap_left",
            TerrainArtPieceKind::TrenchEndCapRight => "trench_end_cap_right",
            TerrainArtPieceKind::BermCornerLeft => "berm_corner_left",
            TerrainArtPieceKind::BermCornerRight => "berm_corner_right",
            TerrainArtPieceKind::LedgeBrokenCorner => "ledge_broken_corner",
            TerrainArtPieceKind::RoadWornEdgePatch => "road_worn_edge_patch",
        }
    }
}
