...
## Current status: ArtGen 2.1b — trench topology polish
...
ArtGen 2.1b keeps grass/dirt/path generation as the top-surface foundation and turns the polished
...
not final trench art; it is to make connected trenches read as one dug feature by suppressing shared
internal lips/walls, resolving junction centers, blending endpoint caps into the trench body, and
making continuity diagnostics easier to inspect in the high-oblique 2.5D sprite contract.
